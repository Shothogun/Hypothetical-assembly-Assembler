...
class symbol_table : public table{
  ...
  public:
    ...
    */
     ...
     * 
    */
    void set_extern(string identifier, bool value){
      this->table[identifier][EXTERN] = (int)value;
    }
    ...
    */
     ...
     * 
    */
    bool get_extern(string identifier);
    //! PrintTable();
    /* A debug function
     *
    */ 
...
//   public:
//     void insert_usage_line(string extern_label, int line_number);
//     void insert_extern_label(string external_label);
//     vector<int> get_usage_lines(string extern_label){
//       return this->table[extern_label];
//     }
// };
...
//   public:
//     void insert_simbol(string simbol, int value);
//     void insert_simbol(string simbol);
//     void set_value(string simbol, int value){
//       this->table[simbol] = value;
//     }
//     int get_value(string simbol){
//       return this->table[simbol];
//     }    
// };
