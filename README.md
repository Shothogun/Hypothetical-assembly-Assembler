...
**Note 1:** When the ```.asm``` code's instructions contains errors, the object code will be filled up with garbage code(code ```99```) to preserve the pretended size for the object code(folowing the valid instructions from the asm code).
